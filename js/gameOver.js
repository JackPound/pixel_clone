var gameOver = {
	...
	create: function (){
		...
		var tryAgain = game.add.text(game.world.centerX, 300, "click anywhere to continue smashin", {
			font: '22px Space Mono', fill: '#ffffff', align: 'center'
		});
		nameLabel.anchor.setTo(.5, .5);
		endScore.anchor.setTo(.5, .5);
		tryAgain.anchor.setTo(.5, .5);
